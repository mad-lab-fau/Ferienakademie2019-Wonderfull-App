...
import de.ferienakademie.wonderfull.LocationGetter;
...
public class BleService extends Service {
    ...
    private ArrayList<Double> gpsBuffer = new ArrayList<>();

    private boolean fall = false;
    double height = 0;
    private LocationManager locationManager = null;
    private LocationGetter.MyLocationListener locationListener = null;
    ...
    public IBinder onBind(Intent intent) {
        ...
        // TODO get location manager and register to location updates
        locationListener = new LocationGetter.MyLocationListener();
    ...
    public boolean onUnbind(Intent intent) {
        ...
        // TODO unregister from location updates
